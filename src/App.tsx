  ...
  return (
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <div className="pt-1  mt-8 bg-galaxy-gradient self-stretch rounded-lg overflow-hidden">
        <div className="bg-[#2A2634] px-8 py-6 self-stretch flex items-center justify-between">
          <div>
          ...
          <button className="px-4 py-3 bg-violet-500 hover:bg-violet-600 text-white rounded flex item-center gap-3">
